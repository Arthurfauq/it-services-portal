...
1. In MySQL, create a database called "it-portal-db". Import the "it-portal-db.sql" file in the database to create the tables. 
...
2. The project runs with Apache Tomcat 8, and the "server.xml" file must include the following for authentication :
...
3. Two users have been added in the database: 
